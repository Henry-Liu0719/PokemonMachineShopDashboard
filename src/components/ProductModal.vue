          ...
          <div class="row">
            ...
            <div class="col-sm-8">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="title" v-model="tempProduct.title" placeholder="請輸入商品名稱" />
              </div>

              <div class="row gx-2">
                <div class="mb-3 col-md-6">
                  <label for="category" class="form-label">屬性</label>
                  <input type="text" class="form-control" id="category" v-model="tempProduct.category"
                    placeholder="請輸入屬性" />
                </div>
                <div class="mb-3 col-md-6">
                  <label for="price" class="form-label">招式名稱</label>
                  <input type="text" class="form-control" id="unit" v-model="tempProduct.unit" placeholder="請輸入招式名稱" />
                </div>
              </div>
